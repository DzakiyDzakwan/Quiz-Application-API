...
export default class UserSeeder {
  static async run() {
    ...
    let users = [
      ...
      {
        fullname: "User Testing 6",
        username: "usertesting06",
        email: "usertesting06@gmail.com",
        password: "usertest0612345",
        roles: ["user"],
        permissions: [],
      },
      {
        fullname: "User Testing 7",
        username: "usertesting07",
        email: "usertesting07@gmail.com",
        password: "usertest0712345",
        roles: ["user"],
        permissions: [],
      },
      {
        fullname: "User Testing 8",
        username: "usertesting08",
        email: "usertesting08@gmail.com",
        password: "usertest0812345",
        roles: ["user"],
        permissions: [],
      },
      {
        fullname: "User Testing 9",
        username: "usertesting09",
        email: "usertesting09@gmail.com",
        password: "usertest0912345",
        roles: ["user"],
        permissions: [],
      },
      {
